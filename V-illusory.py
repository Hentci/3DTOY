...
def main():
    mask_path = '/project/hentci/mip-nerf-360/trigger_bicycle_1pose_fox/mask.png'
    metrics_calculator = MaskedImageMetrics(mask_path)
    
    image1_path = '/project/hentci/GS-backdoor/new_models/clean_pcd_fox2/train/ours_30000/renders/00000.png'
    image2_path = '/project/hentci/mip-nerf-360/trigger_bicycle_1pose_fox/_DSC8679.JPG'
