...
def main():
    ...
    for scene in scenes:
        ...
        # Setup paths
        base_input_dir = f'/project2/hentci/ours_data/tanksandtemples/poison_{scene}'
        ...
        try:
            ...
            result_image_path = f'/project2/hentci/Metrics/ours/single-view/tanksandtemples/poison_{scene}/log_images/iteration_030000.png'
