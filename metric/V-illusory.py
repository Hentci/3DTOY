...
def main():
    ...
    image1_path = '/project/hentci/GS-backdoor/IPA-test/eval_garden_step2/log_images/iteration_030000.png'
    image2_path = '/project/hentci/mip-nerf-360/trigger_garden_fox/DSC07956.JPG'
