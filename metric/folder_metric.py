...
if __name__ == "__main__":
    pred_dir = "/project/hentci/GS-backdoor/scheduling_noise/room_sqrt/test/ours_30000/renders"
    gt_dir = "/project/hentci/GS-backdoor/scheduling_noise/room_sqrt/test/ours_30000/gt"
